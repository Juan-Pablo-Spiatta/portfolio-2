  ...
  return (
    <section className={ style.heroSectionContainer }>
        ...
        <ul className={ style.networksContainer }>
            <li className={ style.networks }><img className={ style.images } src={codepen} alt="linkedin-icon" /></li>
            <li className={ style.networks }><img className={ style.images } src={github} alt="linkedin-icon" /></li>
            <li className={ style.networks }><img className={ style.images } src={linkedin} alt="linkedin-icon" /></li>
        </ul>
    </section>
  )
}
